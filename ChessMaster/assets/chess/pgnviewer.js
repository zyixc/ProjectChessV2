...
PGN.prototype.getPGNFromURL = function (url, _2d) {
    ...
    YAHOO.util.Connect.asyncRequest("GET", url + "?rs=" + _2e, {
        success: function (o) {
            var _30 = "";
            var _31 = "";
            var _32 = "";
...
PGN.prototype.getMoveFromPGNMove = function (_3d, _3e, _3f) {
            ...
            if (_46.length > 1) {
                if (_46.length == 2) {
                    ...
                    if (_46.length == 3) {
                        ...
                        this.lastMoveFromError = __js("Error: unhandled fromChars:{FROM_CHARS}", [
                            ["FROM_CHARS", _46]
                        ]);
                        return null;
                    }
    ...
    if (_4e == 0) {
        this.lastMoveFromError = __js("no candidate pieces for:{MOVE}", [
            ["MOVE", _3d]
        ]);
        return null;
    }
                    ...
                    if (pgn.charAt(i) == "(") {
                        ...
                        if (pgn.charAt(i) == ")") {
                            ...
                            if (pgn.charAt(i) == "$") {
                                ...
                                if (_97.length == 0) {
                                    var err = __js("PgnViewer: Error: got empty move endMoveInd:{ENDMOVE_INDEX} upto:{UPTO} from:{FROM}", [
                                        ["ENDMOVE_INDEX", _95],
                                        ["UPTO", _96],
                                        ["FROM", pgn.substr(_96)]
                                    ]);
                                ...
                                if (_9a == null) {
                                    _82 += "unknown ";
                                    var err = __js("PgnViewer: Error parsing:{MOVE}, {ERROR_REASON}", [
                                        ["MOVE", _97],
...
BoardConfig = function () {
    ...
    this.boardImagePath = "http://www.treegarden.nl/chess";
        ...
        if (this.config.pgnMode) {
            ...
            if (!this.board.dontCheckLeavingPage && this.tactics) {
                ...
                if (typeof showingStart != "undefined" && showingStart) {
                    ...
                    var _27 = new YAHOO.widget.SimpleDialog("starttacticdialog1", {
                        width: "300px",
                        fixedcenter: true,
                        modal: false,
                        visible: true,
                        draggable: true,
                        close: false,
                        text: "<div style=\"color:black\">" + _26 + "</div><br/>" + "<div style=\"color:black\">" + _js("Click start to begin solving problems") + "</div>",
...
ChessPiece = function (div, _5a, _5b, _5c) {
    ...
    if (!this.board.clickAndClick) {
        this.init(id, "ct-" + this.board.boardName + "-boardandpieces", {
...
ChessPiece.prototype.setPosition = function (_9e, row, _a0, _a1, _a2, _a3, _a4) {
    ...
    if (!_a0) {
        ...
        var _aa = new YAHOO.util.Motion(_a5, {
            points: {
                to: _a9
            }
        });
...
Board.prototype.promptPromotion = function (_ff, col, row, _102, _103) {
    ...
    var _104 = this;
    var _105 = new YAHOO.widget.Dialog("promotionDialogId", {
        width: "300px",
        fixedcenter: true,
        visible: true,
        modal: true,
...
Board.prototype.scoreToLongString = function (_12c) {
    ...
    if (_12c == 0) {
        ...
        if (_12c > 0) {
            return __js("Mate in {NUMBER_MOVES}", [
                ["NUMBER_MOVES", _12c]
            ]);
        } else {
            return __js("Lose in {NUMBER_MOVES}", [
                ["NUMBER_MOVES", (-1 * _12c)]
            ]);
        }
    }
...
MovesDisplay.prototype.clickComment = function (e) {
    ...
    mySimpleDialog = new YAHOO.widget.SimpleDialog(this.boardName + "-editCommentDialog", {
        width: "20em",
        fixedcenter: true,
        modal: true,
        visible: false,
...
Board.prototype.setupFromLalgArray = function (_1bd, _1be, _1bf, _1c0, _1c1, _1c2, _1c3, _1c4, _1c5, _1c6, _1c7, _1c8) {
    ...
    for (var i = 0; i < _1bd.length; i++) {
        ...
        if (_1bd[i].indexOf("TIME") == 0) {
            ...
            var t = parseInt(time);
            var nps = " " + __js("nps:{NODES_PER_SECOND}", [
                ["NODES_PER_SECOND", Math.round(parseInt(_1e1) / (parseInt(time) / 1000))]
            ]);
            if (!this.showNPS) {
                nps = "";
            }
            if (!(_1d4 > 0 && _1d7[_1d4] > this.ml)) {
                _1bd[i] = _1e9 + e + " (" + __js("depth:{DEPTH}", [
                    ["DEPTH", _1e0]
                ]) + nps + ")";
            } else {
                _1bd[i] = "";
...
Board.prototype.displayPendingMoveList = function () {
    if (this.pendingMovesOutput && this.movesDisplay) {
        ...
        if (_243) {
            ...
            var _244 = new YAHOO.util.Scroll(_243, {
                scroll: {
                    to: [0, 0]
                }
            }, 0);
            ...
            if (this.autoScrollMoves) {
                if (!_2bc && (this.scrollVariations || cls.indexOf("ct-board-move-variation") == -1)) {
                    ...
                    if (_2c0) {
                        ...
                        var _2c3 = new YAHOO.util.Scroll(_2c0, {
                            scroll: {
                                by: [0, y - this.scrollOffsetCorrection]
                            }
...
Board.prototype.resetMoveListScrollPosition = function () {
    ...
    if (_3aa) {
        var _3ab = new YAHOO.util.Scroll(_3aa, {
            scroll: {
                to: [0, 0]
            }
        }, 0);
...
Board.prototype.showBoardFen = function (e) {
    var fen = this.boardToFen();
    var _428 = new YAHOO.widget.SimpleDialog("fenDialog", {
        fixedcenter: false,
        visible: true,
        draggable: true,
    ...
    if (this.problem && this.problem.comments) {
        var _42a = new YAHOO.widget.Button({
            type: "button",
    ...
    if (this.gameComments) {
        var _42b = new YAHOO.widget.Button({
            type: "button",
    ...
    if (this.playerComments) {
        var _42c = new YAHOO.widget.Button({
            type: "button",
    ...
    if (this.openingComments) {
        var _42d = new YAHOO.widget.Button({
            type: "button",
    ...
    var _42e = new YAHOO.widget.Button({
        type: "button",
        label: _js("Ok"),
        container: "fenok",
        onclick: {
